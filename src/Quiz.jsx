...
const Quiz = ({ questions }) => {
  ...
  const onAnswerClick = (choice, index) => {
    //Collects the right choice and its index eg 1,2,3
  ...
  const onClickNext = () => {
    ...
    //Now we need to move to the next question after the next button is clicked
      ...
      {!showResult ? (
        ...
        <div className="result">
          ...
          <p>
            ...
            <span>
              {" "}
              You scored {result.correctAnswers} out of {questions.length}
            </span>
          </p>
